...
public class FactureValidator extends Validator<Facture> {
    public FactureValidator(Facture item) {
        super(item);
    }

    public static void validate(Facture item) {
        new FactureValidator(item).validate();
    }
