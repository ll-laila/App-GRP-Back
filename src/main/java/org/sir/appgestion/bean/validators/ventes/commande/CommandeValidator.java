...
public class CommandeValidator extends Validator<Commande> {
    public CommandeValidator(Commande item) {
        super(item);
    }

    public static void validate(Commande item) {
        new CommandeValidator(item).validate();
    }
